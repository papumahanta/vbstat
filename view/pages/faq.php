<?php 
$title = 'FAQs';
$description='Frequently asked questions about Statistics department , VisvaBharati University  -  this page is an unofficial and maintained by statistics students of department of statistics  visva bharati university';
$keywords='privacy , policy, vbstat, statistics, department, lecture, pdf, note, visvabharati';
